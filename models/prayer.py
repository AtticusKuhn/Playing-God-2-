...
class Prayer:
    ...
    def __init__(self, content, urgency):
        self.outgoing_prayer = Message(
            content=content, timestamp=datetime.now(), urgency=urgency, type="Prayer"
        )
    ...
    def answer(self, response_type: str, response: Optional[str] = None) -> None:
        ...
        self.gods_reply = Message(
            content=response, timestamp=datetime.now(), type=response_type
        )
