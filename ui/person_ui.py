...
class PersonUI:
    ...
    def handle_input(self, event: pygame.event.Event) -> bool:
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            panel_rect = pygame.Rect(
                self.padding, self.padding, self.width, self.height
            )
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        panel_rect = pygame.Rect(self.padding, self.padding, self.width, self.height)
        ...
        faith_fill = pygame.Rect(self.padding + 10, y, faith_width * attrs.faith, 10)
        ...
        emotion_fill = pygame.Rect(
            self.padding + 10, y, faith_width * attrs.emotional_state, 10
        )
        ...
        satisfaction_fill = pygame.Rect(
            self.padding + 10, y, faith_width * attrs.life_satisfaction, 10
        )
    ...
    def _draw_text(
        self, screen: pygame.Surface, text: str, y: int, font=None, wrap_width=None
    ):
        ...
        if wrap_width:
            ...
            for line in lines:
                ...
                screen.blit(text_surface, (self.padding * 2, y))
                y += font.get_linesize()
        else:
